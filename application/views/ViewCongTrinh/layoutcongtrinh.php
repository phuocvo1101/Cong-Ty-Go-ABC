...
<html lang="en">
  ...
  <body>
    ...
    <?php $this->load->view('ViewCongTrinh/menucongtrinh'); ?>

    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li class="active"><a href="#"><h4>Công Trình </h4><span class="sr-only">(current)</span></a></li>
        </ul>
          <?php $this->load->view('Viewtintuc/menuLeft_tt'); ?>
        </div>
